...
input_file = os.path.join(os.path.dirname(input_file_csv), os.path.splitext(os.path.basename(input_file_csv))[0] + "_ehr_input_file_SAFE_TO_DELETE.jsonl") # path of the .jsonl file created from the .parquet file, specifically to be used by this file
